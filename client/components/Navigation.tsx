                    ...
                    >
                      <div className="flex items-center space-x-1 lg:space-x-2">
                        ...
                        {item.badge && (
                          <Badge
                            variant="secondary"
                            className="text-xs vietnamese-text"
                          >
                            {item.badge}
                          </Badge>
                        )}
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent className="w-56" align="end" forceMount>
                    <div className="flex flex-col space-y-1 p-2">
                      <p className="text-sm font-medium leading-none vietnamese-text">
                      ...
                      <Badge
                        variant="outline"
                        className="w-fit text-xs mt-1 vietnamese-text"
                      >
                        {user.role === "admin"
                          ? "Quản trị viên"
                          : user.role === "claims_manager"
                            ? "Quản lý bồi thường"
                            : user.role === "claim_executive"
                              ? "Nhân viên xử lý"
                    ...
                    <DropdownMenuItem asChild>
                      <Link
                        to="/profile"
                        className="cursor-pointer vietnamese-text"
                      >
                ...
                <div className="flex items-center space-x-2">
                  <Link to="/login">
                    <Button
                      variant="outline"
                      size="sm"
                      className="vietnamese-text text-xs sm:text-sm"
                    >
                      Đăng nhập
                    </Button>
                  </Link>
